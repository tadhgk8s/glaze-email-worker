/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6c2ee183031abeec494e61a7d999a90b)
// Runtime types generated with workerd@1.20260714.1 2026-07-21 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	EMAIL: SendEmail;
	MAILBOX_ADDRESS: "hello@example.com";
	MAILBOX_DISPLAY_NAME: "Mailbox";
	APP_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAILBOX_ADDRESS" | "MAILBOX_DISPLAY_NAME" | "APP_TOKEN">> {}
}
